class Scene2 extends Phaser.Scene{
	...
	create(){
		...
		const currentAirplane = localStorage.getItem('currentAirplane') || 'airplane.png';

		let hangarPreview = this.add.image(config.width / 2, config.height / 3 - 200, currentAirplane);
